...
function renderGameCard(game) {
    ...
    const badge = status.label
        ...
        : "";
    return `<li class="card game-card" data-status="${escapeAttr(game.status ?? "")}"><a class="game-card__link" href="${safeHref}"><div class="game-card__header"><div class="game-card__meta"><span class="game-card__time">${timeLabel}</span>${statusDetail}</div>${badge}</div><div class="game-card__body">${renderTeamRow(game.visitor_team, awayScore, false, awayLeading)}${renderTeamRow(game.home_team, homeScore, true, homeLeading)}</div></a></li>`;
}
