...
function renderErrorCard(where, target, detail) {
    ...
    const existing = app.querySelector('.error-card[data-health-card="true"]');
...
export async function requireOk(url, where, init) {
