...
const LEADERBOARD_MINIMUM_SAMPLE_SIZE: Record<LeaderboardMetricId, number> = {
  mp: 12,
  fgPct: 15,
  fg3Pct: 15,
  ftPct: 15,
...
function getLeaderboardMinimumSample(metricId: LeaderboardMetricId): number {
...
function leaderboardEntryMeetsMinimumSample(
