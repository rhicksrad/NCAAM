...
export type LeaderboardCardDefinition = {
  id: string;
  title: string;
  seasonLabel?: string;
  ariaLabel?: string;
...
export function renderLeaderboardCards(
  container: HTMLElement,
  cards: LeaderboardCardDefinition[],
...
function createLeaderboardCard(
  cardDef: LeaderboardCardDefinition,
  options: InternalCardOptions,
): HTMLElement {
  const card = document.createElement("article");
...
type InternalMetricOptions = InternalCardOptions;

function renderMetricChart(
  container: HTMLElement,
  cardDef: LeaderboardCardDefinition,
  options: InternalMetricOptions,
): void {
