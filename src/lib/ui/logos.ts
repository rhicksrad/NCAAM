...
function slugify(tokens: readonly string[]): string {
  return tokens.join("-");
}
...
function findByTokens(tokens: readonly string[]): string | undefined {
...
function resolveFromTokens(tokens: readonly string[]): string | undefined {
...
export function getTeamLogoPath(team: Team): string | undefined {
